...
namespace Pal.Persistence.Migrations
{
    ...
    [Migration("20260428033625_Phase4AlertSnoozeColumn")]
    partial class Phase4AlertSnoozeColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pal.Persistence.Entities.AnalysisJobEntity", b =>
                {
                    ...
                    b.Property<string>("BaselineContextJson")
                        .HasColumnType("text")
                        .HasColumnName("baseline_context_json");
            ...
            modelBuilder.Entity("Pal.Persistence.Entities.AnalysisResultEntity", b =>
                {
                    ...
                    b.Property<long?>("DatasetByteLength")
                        .HasColumnType("bigint")
                        .HasColumnName("dataset_byte_length");

                    b.Property<bool?>("DatasetCompressed")
                        .HasColumnType("boolean")
                        .HasColumnName("dataset_compressed");

                    b.Property<string>("DatasetStoragePath")
                        .HasColumnType("text")
                        .HasColumnName("dataset_storage_path");
            ...
            modelBuilder.Entity("Pal.Persistence.Entities.IngestionScheduleEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("PackIds")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("pack_ids");

                    b.Property<string>("SourceConfigJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("source_config_json");
                    ...
                    b.HasIndex("Enabled", "NextRunAt")
                        .HasDatabaseName("ix_ingestion_schedules_enabled_next_run_at");

                    b.HasIndex("WorkspaceId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_ingestion_schedules_workspace_id_name");

                    b.ToTable("ingestion_schedules", (string)null);
                });
