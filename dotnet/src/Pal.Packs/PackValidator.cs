...
public sealed class PackValidator
{
    ...
    private static readonly HashSet<string> ValidCategories = ["cpu", "memory", "disk", "network", "process", "iis", "sql", "dotnet", "ad", "print", "hyperv", "sharepoint", "exchange", "citrix", "dynamics", "sfb", "system", "collection", "pack-validation"];
