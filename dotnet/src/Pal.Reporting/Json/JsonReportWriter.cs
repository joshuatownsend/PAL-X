    ...
    private static object BuildDocument(WriteInput input)
    {
        ...
        return new
        {
            ...
            summary = new
            {
                ...
                finding_counts = new
                {
                    critical = input.Findings.Count(f => f.Severity == "critical"),
                    warning = input.Findings.Count(f => f.Severity == "warning"),
                    informational = input.Findings.Count(f => f.Severity == "informational")
                },
